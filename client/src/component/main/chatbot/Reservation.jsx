...
export default function Reservation() {
  ...
  useEffect(() => {
    if (reserMessage !== "" && reserMessage1 !== "") {
      ...
      axios
        .post("http://localhost:9000/chatbot/searchReservation", {
          reserMessage1,
          reserMessage,
        })
        .then((res) => {
          if (res.data.result === 1) {
            axios
              .post("http://localhost:9000/chatbot/getReservation", {
                reserMessage1,
                reserMessage,
              })
              .then((res) => {
        ...
        <>
          <div>
            ...
            {reservationNo && (
              <div ref={btnRef}>
                <p>
                  입력하신 예약번호로는 예약 내역을 찾을수가 없습니다.
                  <br />
                  혹시 여행사를 통하여 항공권을 구매하셨다면,
                  <br />
                  진에어 홈페이지에서 확인이 안되오니
                  <br /> 고객서비스센터(1600-6200)로 전화 주시거나
                  <br />
