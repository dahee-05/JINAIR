    ...
    <div className="chatbot-buyticket-all-box">
      ...
      {onewayClick && (
        <div className="schedule-all-box">
          ...
          <p>
            *상기 운임은 참고사항으로, 공항 사정이나 일정에 따라 수시로 변동 될
            수 있습니다.
          </p>
          ...
          <div>
            <p>
              월별 최저가 운임은 성인 1인 기준으로, 여러 좌석 예매를 진행 하실
              경우
              <br /> 남은 좌석에 따라 운임이 변동 될 수 있습니다. 또한 동일한
              운임이 있을 경우
      ...
      {exist && (
        <div className="schedule-all-box buyticket-none">
          <p>
            조회하신 날짜는 현재 예약이 마감되었거나,
            <br /> 운항편이 존재하지 않습니다.
            <br /> 다른 날짜로 일정을 조회해 주세요.
          </p>
        </div>
      )}
      {roundtrip && (
        ...
        <div className="schedule-all-box">
          ...
          <div className="cheap-cheap-month">
            ...
            <div className="cheap-round-desc">
              <p>
                월별 최저가 운임은 성인 1인 기준으로, 여러 좌석 예매를 진행 하실
                경우 남은 좌석에 따라 운임이 변동 될 수 있습니다. 또한 동일한
                운임이 있을 경우 가장 가까운 날짜를 알려드립니다.
              </p>
            </div>
          </div>
        </div>
