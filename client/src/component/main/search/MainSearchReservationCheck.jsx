...
export default function MainSearchReservationCheck() {
  ...
  const handleCheckIn = (e) => {
    ...
    if (validate()) {
      ...
      axios
        .post("http://localhost:9000/chatbot/checkCheckIn", {
          id: id,
          rnum: form.rnum,
        })
        .then((res) => {
          if (res.data.result === 1) {
            ...
            alert(
              "예약번호로 일치하는 예약이 없습니다. 확인 후 다시 시도해주세요.",
            );
          }
        })
    ...
    <form onSubmit={handleCheckIn}>
      ...
      <div className="main-top-search-bottom3">
        <ul>
          <li>
            ...
            <input
              ...
              name="rnum"
              ref={refs.rnumRef}
              placeholder="숫자와 영문으로 조합된 6자리"
            />
            {err.rnum ? (
              <p style={{ color: "red" }} ref={rnumErr}>
                {err.rnum}
              </p>
            ) : (
              <p>흠</p>
          ...
          <li>
            ...
            />
            {err.firstNm ? (
              <p style={{ color: "red" }} ref={firstErr}>
                {err.firstNm}
              </p>
            ) : (
              <p>흠</p>
          ...
          <li>
            ...
            <div>
              <input
                ...
                type="textonly"
                name="departDay"
                ref={refs.departDayRef}
                className="active-calendar-input"
                value={startDate}
              />
              <FaCalendarCheck
                onClick={() => {
            ...
            {err.departDay ? (
              <p style={{ color: "red" }} ref={departErr}>
                {err.departDay}
              </p>
            ) : (
              <p>흠</p>
        ...
        <div>
          <ul>
            <li>
              * 예약 시 입력한 승객명을 입력해주세요. (국내선 국문 예약은 국문
              성/이름, 국제선은 영문 성/이름)
            </li>
